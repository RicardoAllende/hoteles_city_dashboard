...
(
	u.institution LIKE '___CECMA'
	AND 
	(
		(cc.course=5 OR cc.course=6 OR cc.course=7 
		OR cc.course=11 
		OR cc.course=73 OR cc.course = 77 
		OR cc.course=38 OR cc.course=44 
		OR cc.course = 50 
		OR cc.course = 71 
		OR cc.course = 75 OR cc.course = 93
		OR cc.course = 116 OR cc.course = 101 
...
OR 
(
	u.institution LIKE '__CECEA' 
	AND 
	(
		(cc.course = 18 
		OR cc.course=73 OR cc.course = 77 
		OR cc.course=38 OR cc.course=44 
		OR cc.course = 50 OR cc.course = 57 
		OR cc.course = 71 OR cc.course = 75 
		OR cc.course = 89 OR cc.course = 88 
		OR cc.course = 93 OR cc.course = 83 
		OR cc.course = 116 OR cc.course = 101 
		OR cc.course = 114 OR cc.course = 115 
		OR cc.course = 74 OR cc.course=130
		OR cc.course = 262 OR  cc.course=131 
...
AND u.suspended = 0 AND c.visible = 1) AS a ON a.usuario=mat.Usuario AND a.Curso=mat.Curso
